...
command sudo apt-get install -qq -y python3 python3-pip fonts-firacode network-manager diodon flameshot htop qt5ct \
      lxpolkit lxterminal lxappearance pavucontrol arandr pcmanfm xarchiver xournalpp firefox vlc nitrogen gparted \
