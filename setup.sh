...
command sudo apt-get install -qq -y python3 python3-pip fonts-ubuntu fonts-firacode \
      network-manager diodon firefox pcmanfm xarchiver lxpolkit lxterminal lxappearance \
      adwaita-icon-theme-full pavucontrol arandr || error-echo "installing from apt"
