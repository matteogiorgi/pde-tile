...
command sudo apt-get install -qq -y python3 python3-pip fonts-firacode network-manager diodon firefox pcmanfm xarchiver arandr \
      lxpolkit lxterminal lxappearance adwaita-icon-theme-full pavucontrol xsettingsd || error-echo "installing from apt"
