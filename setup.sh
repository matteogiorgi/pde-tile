...
command sudo apt-get install -qq -y python3 python3-pip fonts-firacode network-manager diodon flameshot \
      lxpolkit lxterminal lxappearance pavucontrol arandr pcmanfm xarchiver xournalpp firefox nitrogen \
      gparted xsettingsd libwacom9 xserver-xorg-input-wacom adwaita-icon-theme-full || error-echo "installing from apt"
