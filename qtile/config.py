...
keys = [
    ...
    Key([mod], "a", lazy.group.focus_back(), desc="Move window focus to last window"),
    Key([mod], "s", lazy.group.next_window(), desc="Move window focus to next window"),
    Key([mod], "d", lazy.spawn("/usr/bin/diodon"), desc="Launch Diodon"),
    Key([mod], "f", lazy.spawn("/usr/bin/flameshot gui"), desc="Launch Flameshot"),
    Key([mod], "c", lazy.spawncmd(), desc="Spawn a command using a prompt widget"),
    Key([mod], "v", lazy.spawn("/usr/bin/gvim"), desc="Launch GVim"),
    Key([mod], "b", lazy.next_screen(), desc="Move focus to next monitor"),
